...
#API
#MVP doesn't include this but our final product will take the "Brand Name" text input from the AI model and then pass it into the API, and then display the result on the website
